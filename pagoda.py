...
train_zip = GoogleFile('0BxsB7D9gLcdOQkdoQXRUMDdUUnM', 'train.zip', 'data/train.zip')
# test_zip = GoogleFile('0BzL8pCLanAIAZTlvcEs3U082U00', 'test1.zip', 'data/test1.zip')
...
lmdb = CreateLmdb()
lmdb.create_lmdb("data/train", "data/train_lmdb", "data/validation_lmdb", "cat")

train_lmdb = "data/train_lmdb"
validation_lmdb = "data/validation_lmdb"
mean_proto = "data/mean.binaryproto"
...
caffe_train_model = "caffe_model/caffenet_train.prototxt"
caffe_solver = "caffe_model/caffenet_solver.prototxt"
...
# print "\n\n------------------------TESTING PHRASE-----------------------------\n\n"
#
# caffe_deploy = "caffe_model/caffenet_deploy.prototxt"
#
# render_template("template/caffenet_deploy.template", caffe_deploy)
#
# mean_data = read_mean_data(mean_proto)
# net = read_model_and_weight(caffe_deploy, "caffe_model/caffe_model/snapshot_10000.caffemodel")
# transformer = image_transformers(net, mean_data)
# prediction = making_predictions("data/test1", transformer, net)
#
# export_to_csv(prediction, "result/test_result.csv")
#
# print "\n\n-------------------------FINISH------------------------------------\n\n"
